...
class AestheticLoss(LossInterface):
    ...
    def __init__(self, **kwargs):
        ...
        if not self.model_path.exists():
            wget_file(
                "https://dazhi.art/f/ava_vit_b_16_linear.pth",
                self.model_path)
