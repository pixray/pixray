...
class TestUtilMethods(unittest.TestCase):
    ...
    def test_get_file_path_no_backslash(self):
        self.assertEqual(
            get_file_path("/testpath", "testfile", ".png"), "/testpath/testfile.png"
        )
    ...
    def test_get_file_path_filename_contains_backslash(self):
        self.assertRaises(
            ValueError, get_file_path, "/testpath/", "\\test\\filename.png", ".png"
        )

    def test_get_file_path_filename_contains_slash(self):
        self.assertRaises(
            ValueError, get_file_path, "/testpath/", "/test/filename.png", ".png"
        )
    ...
    def test_get_file_path_replaces_suffix(self):
        self.assertEqual(
            get_file_path("/testpath", "testfile.png", ".mp4"), "/testpath/testfile.mp4"
        )
    ...
    def test_parse_unit_leading_decimal_iterations(self):
        self.assertEqual(parse_unit(0.6, 500, "overlay_until", "i"), 0)

    def test_parse_unit_leading_decimal_percent(self):
        self.assertEqual(parse_unit(0.5, 500, "overlay_until", "p"), 2)
